...
public class EyAPF extends JFrame {
    ...
    EyAPF(){
				...
				botonesPnl.setLayout(new GridBagLayout());
                                ...
                                AgregarPL = new JLabel ("Fecha de vencimiento de Primera Letra Por Pagar", JLabel.CENTER);
                                        c.gridheight = 1;
					c.gridwidth = 3;
					c. gridx = 0;
					c. gridy = 3;
					panel.add(AgregarPL, c);
                                ...
                                dia = new JLabel ("Dia", JLabel.CENTER);
					c.gridwidth = 1;
					c. gridx = 0;
					c. gridy = 4;
					panel.add(dia, c);
					...
					panel.add(anio2, c);
                                ...
                                anio = new JLabel ("Monto de Letras:", JLabel.CENTER);
					c.gridwidth = 2;
					c. gridx = 0;
					c. gridy = 6;
					panel.add(anio, c);
					...
					panel.add(montoLetra, c);
                                ...
                                anio = new JLabel ("Porcentaje de Descuento en Intereses:", JLabel.CENTER);
					c.gridwidth = 2;
					c. gridx = 0;
					c. gridy = 7;
					panel.add(anio, c);
					...
					panel.add(porcentajeDesc, c);
                                ...
                                anio = new JLabel ("Numero de Letras por Pagar:", JLabel.CENTER);
					c.gridwidth = 1;
					c. gridx = 0;
					c. gridy = 8;
					panel.add(anio, c);
					...
					panel.add(anio, c);
                                ...
                                anio = new JLabel ("Monto Inicial:", JLabel.CENTER);
					c.gridwidth = 1;
					c. gridx = 3;
					c. gridy = 8;
					panel.add(anio, c);
					...
					panel.add(restanteInicial, c);
                                ...
                                AgregarP = new JButton ("Revisar 2");
